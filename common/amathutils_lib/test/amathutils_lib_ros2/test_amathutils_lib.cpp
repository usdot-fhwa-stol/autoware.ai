...
{
  geometry_msgs::msg::Point a, b, p, nearPOut, nearP;
...
{
  geometry_msgs::msg::Point ptA, ptB;
...
{
  geometry_msgs::msg::Point l1_p1, l1_p2, l2_p1, l2_p2;
  l1_p1.x = 29;
  l1_p1.y = 5;
  l1_p1.z = 0;
  l1_p2.x = 51;
...
{
  geometry_msgs::msg::Point p1, line_p1, line_p2;
  p1.x = 1;
  p1.y = 10;
  p1.z = 0;
  line_p1.x = 1;
...
{
  geometry_msgs::msg::Point p, line_p1, line_p2;
  p.x = 1;
  p.y = 1;
  p.z = 0;
  line_p1.x = 0;
...
{
  geometry_msgs::msg::Point line1_p1, line1_p2, line2_p1, line2_p2, intersect_p;
  line1_p1.x = 5;
  line1_p1.y = 0;
  line1_p2.x = 5;
  line1_p2.y = 10;
