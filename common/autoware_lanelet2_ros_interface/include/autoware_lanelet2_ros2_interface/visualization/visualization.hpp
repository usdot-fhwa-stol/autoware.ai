 ...
 * @param triangles [array of polygon message, each containing 3 vertices]
 */
void lanelet2Triangle(const lanelet::ConstLanelet& ll, std::vector<geometry_msgs::msg::Polygon>* triangles);
/**
 ...
 */
void lineString2Marker(const lanelet::ConstLineString3d ls, visualization_msgs::msg::Marker* line_strip,
 ...
 */
visualization_msgs::msg::MarkerArray laneletsBoundaryAsMarkerArray(const lanelet::ConstLanelets& lanelets,
                                                              const std_msgs::msg::ColorRGBA c, const bool viz_centerline);
/**
 ...
 */
visualization_msgs::msg::MarkerArray laneletsAsTriangleMarkerArray(const std::string ns,
 ...
 * @return          [created marker array]
 */
visualization_msgs::msg::MarkerArray laneletDirectionAsMarkerArray(const lanelet::ConstLanelets lanelets);
 ...
 * @return              [created marker array]
 */
visualization_msgs::msg::MarkerArray lineStringsAsMarkerArray(const std::vector<lanelet::ConstLineString3d> line_strings,
