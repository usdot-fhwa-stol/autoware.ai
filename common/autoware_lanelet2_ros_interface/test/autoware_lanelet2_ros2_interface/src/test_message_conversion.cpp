...
TEST_F(TestSuite, ToGeomMsgPt)
{
  ...
  ASSERT_FLOAT_EQ(geom_pt32.x, geom_pt.x) << " converted value is different from original geometry_msgs::msg::Point";
  ASSERT_FLOAT_EQ(geom_pt32.y, geom_pt.y) << " converted value is different from original geometry_msgs::msg::Point";
  ASSERT_FLOAT_EQ(geom_pt32.z, geom_pt.z) << " converted value is different from original geometry_msgs::msg::Point";
