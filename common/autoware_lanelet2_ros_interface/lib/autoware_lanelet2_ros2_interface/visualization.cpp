...
#include <amathutils_lib_ros2/amathutils.hpp>

namespace
{
void adjacentPoints(const int i, const int N, const geometry_msgs::msg::Polygon poly, geometry_msgs::msg::Point32* p0,
                    geometry_msgs::msg::Point32* p1, geometry_msgs::msg::Point32* p2)
{
  if (p0 == nullptr || p1 == nullptr || p2 == nullptr)
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("lanelet::visualization"),__FUNCTION__ << ": either p0, p1, or p2 is null pointer!");
    return;
  }
...
void lightAsMarker(lanelet::ConstPoint3d p, visualization_msgs::msg::Marker* marker, const std::string ns)
{
  if (marker == nullptr)
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("lanelet::visualization"),__FUNCTION__ << ": marker is null pointer!");
    return;
  }
...
bool isReflexAngle(const geometry_msgs::msg::Point32& a, const geometry_msgs::msg::Point32& o, const geometry_msgs::msg::Point32& b)
{
...
bool isWithinTriangle(const geometry_msgs::msg::Point32& a, const geometry_msgs::msg::Point32& b, const geometry_msgs::msg::Point32& c,
...
namespace lanelet
{
void visualization::lanelet2Triangle(const lanelet::ConstLanelet& ll, std::vector<geometry_msgs::msg::Polygon>* triangles)
{
  if (triangles == nullptr)
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("lanelet::visualization"),__FUNCTION__ << ": triangles is null pointer!");
    return;
  }
...
void visualization::polygon2Triangle(const geometry_msgs::msg::Polygon& polygon,
                                     std::vector<geometry_msgs::msg::Polygon>* triangles)
{
  ...
  while (N >= 3)
  {
    ...
    {
      RCLCPP_ERROR(rclcpp::get_logger("lanelet::visualization"),"Could not find valid vertex for ear clipping triangulation. Triangulation result might be invalid");
      clipped_vertex = 0;
    }
...
void visualization::lanelet2Polygon(const lanelet::ConstLanelet& ll, geometry_msgs::msg::Polygon* polygon)
{
  if (polygon == nullptr)
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("lanelet::visualization"), __FUNCTION__ << ": polygon is null pointer!");
    return;
  }
...
visualization_msgs::msg::MarkerArray visualization::laneletDirectionAsMarkerArray(const lanelet::ConstLanelets lanelets)
{
...
visualization::lineStringsAsMarkerArray(const std::vector<lanelet::ConstLineString3d> line_strings,
                                        const std::string name_space, const std_msgs::msg::ColorRGBA c, const double lss)
{
...
visualization_msgs::msg::MarkerArray visualization::laneletsBoundaryAsMarkerArray(const lanelet::ConstLanelets& lanelets,
...
visualization_msgs::msg::MarkerArray visualization::laneletsAsTriangleMarkerArray(const std::string ns,
...
void visualization::trafficLight2TriangleMarker(const lanelet::ConstLineString3d ls, visualization_msgs::msg::Marker* marker,
...
void visualization::lineString2Marker(const lanelet::ConstLineString3d ls, visualization_msgs::msg::Marker* line_strip,
                                      const std::string frame_id, const std::string ns, const std_msgs::msg::ColorRGBA c,
                                      const float lss)
{
  if (line_strip == nullptr)
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("lanelet::visualization"),__FUNCTION__ << ": line_strip is null pointer!");
    return;
  }
