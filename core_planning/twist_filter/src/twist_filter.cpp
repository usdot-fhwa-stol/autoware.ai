    ...
    : carma_ros2_utils::CarmaLifecycleNode(options)
{
  ...
  // Declare parameters
  wheel_base_ = declare_parameter<double>("vehicle_info/wheel_base", wheel_base_);
  longitudinal_velocity_limit_ = declare_parameter<double>("longitudinal_velocity_limit", longitudinal_velocity_limit_);
  longitudinal_accel_limit_ = declare_parameter<double>("longitudinal_accel_limit", longitudinal_accel_limit_);
  lateral_accel_limit_ = declare_parameter<double>("lateral_accel_limit", lateral_accel_limit_);
  lateral_jerk_limit_ = declare_parameter<double>("lateral_jerk_limit", lateral_jerk_limit_);
